...
* Compartir ubicación en tiempo real con contactos de confianza.
* Visualización de mapa de riesgo con zonas peligrosas.
* Consulta de rutas seguras para reducir riesgos durante los trayectos.
* Reporte de incidentes comunitarios.
* Historial de alertas y recorridos.
* Gestión de contactos de confianza.
* Configuración de dispositivos IoT, como botón físico SOS.
...
* User Personas.
* Entrevistas a estudiantes y trabajadores.
...
* Entrevistas a trabajadores con horarios extendidos.
* Validación de la Landing Page.
* Validación de prototipos.
* Pruebas de usabilidad.
* Revisión de navegación y claridad visual.
...
* Diseño UX/UI desarrollado.
* Landing Page implementada.
* Pantallas principales implementadas.
* Prototipos web y mobile realizados.
